...
const limitarAcesso = require('../middlewares/limitaAcesso')
const gerarLogs = require('../middlewares/gerarLogs')
...
const rotas_usuarios = () => {
    ...
    router.get("/usuarios/:id", (req, res) => {
        try {
            // gerar os logs
            gerarLogs(req.headers['authorization'], "get via id")
            // limitando o acesso do usuario que fez a requisicao
            const idUserReq = limitarAcesso(req.headers['authorization'])
    ...
    router.post("/usuarios", (req, res) => {
        try {
            // gerar os logs
            gerarLogs(req.headers['authorization'], "post de novo usuario")
    ...
    router.put("/usuarios/:id", (req, res) => {
        try {
            // gerar os logs
            gerarLogs(req.headers['authorization'], "put de usuario via id")
            // limitando o acesso do usuario que fez a requisicao
            const idUserReq = limitarAcesso(req.headers['authorization'])
    ...
    router.patch("/usuarios/:id", (req, res) => {
        // gerar os logs
        gerarLogs(req.headers['authorization'], "patch de usuario via id")
    ...
    router.delete("/usuarios/:id", (req, res) => {
        // gerar os logs
        gerarLogs(req.headers['authorization'], "delete de usuario via id")
